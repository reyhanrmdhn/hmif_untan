...
<!-- ***** Team Area Start ***** -->
<section class="section team-area team-style-two overflow-hidden ptb_100" id="screenshots">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-12 col-md-10 col-lg-8">
                <!-- Section Heading -->
                <div class="section-heading text-center wow fadeInDown" data-wow-delay="0.2s">
        ...
        <div class="row popup-gallery">
            <?php foreach ($gallery as $g) : ?>
                <div class="col-12 col-sm-6 col-md-4 col-lg-3 mix kategori-15 wow fadeInUp" data-wow-delay="0.2s">
                    <div class="single-team text-center overflow-hidden m-2 m-lg-0">
                        <a href="<?= base_url('assets/images/gallery/' . $g['gambar']) ?>" title="<?= $g['judul'] ?>">
        ...
        <div class="row">
            <div class="col-12 blog mt-5 text-center wow fadeInUp" data-wow-delay="0.4s">
